...
<tbody>
            ...
            <tr>
              ...
              <?php if($_SESSION['role_id']==1){ ?>
                <td>
                  <a href="#" class="btn btn-danger" title="Change Team Status" onclick="window.open('teamstatus.php?team_id=<?=$table->id?>', 'newwindow', 'width=500,height=500'); return false;"><i class='fa fa-gg-circle' aria-hidden='true'></i></a>
