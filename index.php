    ...
    <div class="row">
      ...
      <nav id="sidebar" class="col-md-3 bg-light">
        <table class="table table-borderless">
          ...
          <tr>
            <td><a href="#" data-bs-toggle="modal" data-bs-target="#goalParametersModal">Create</a></td>
          </tr>
          <?php }?>
          <!-- Add Logout link -->
          <tr>
            ...
            <div class="modal-body">
              ...
              <div id="inputContainer">
                ...
                <div className="form-group">
                  ...
                  <select class="form-select" name="team_name" onchange="createNewInput()" aria-label="Default select example" required>
